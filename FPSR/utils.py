...
class RecTrainer(object):
    ...
    def train(self, verbose=False):
        ...
        self.logger.info("Users: " + str(len(self.train_data.dataset.user_counter))
                         + "\t Items: " + str(len(self.train_data.dataset.item_counter))
                         + "\t Interactions: " + str(self.train_data.dataset.inter_num))
